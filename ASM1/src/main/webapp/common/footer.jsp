            ...
            <div class="info-wrap">
              <div class="row">
                <div class="col-lg-4 info">
                  ...
                  <h4>Location:</h4>
                  <p>Công Viên Phần Mềm Quang Trung<br>Quận 12, TP HCM</p>
                </div>

                <div class="col-lg-4 info mt-4 mt-lg-0">
                  <i class="bi bi-envelope"></i>
                  <h4>Email:</h4>
                  <p>ducthang12c8@gmail.com</p>
                </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Lumia</h3>
            <p>
              Công viên phần mềm Quang Trung quận 12 TPHCM <br><br>
              <strong>Phone:</strong> +84362869856<br>
              <strong>Email:</strong> ducthang12c8@gmail.com<br>
            </p>
          </div>
